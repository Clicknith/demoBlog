...
class User implements UserInterface
{
    ...
    // In Order to encode the passwords, the entitiy 'User' must implement "UserInterface", this Interface includes the following methods that should be declared such as : getPassword() , get Username(), getRoles(), getSalt() and eraseCredentials()
